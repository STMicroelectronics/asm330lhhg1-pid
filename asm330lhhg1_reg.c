                                     ...
                                     asm330lhhg1_odr_xl_t val)
{
  ...
  if (ret == 0)
  {
    ctrl1_xl.odr_xl = (uint8_t)(odr_xl & 0x0F);
    ret = asm330lhhg1_write_reg(ctx, ASM330LHHG1_CTRL1_XL,
                                (uint8_t *)&ctrl1_xl, 1);
  }
...
{
  asm330lhhg1_ctrl2_g_t ctrl2_g = {0};
  int32_t ret = 0;
                                     ...
                                     asm330lhhg1_odr_g_t val)
{
  ...
  if (ret == 0)
  {
    ctrl2_g.odr_g = (uint8_t)(odr_gy & 0x0F);
    ret = asm330lhhg1_write_reg(ctx, ASM330LHHG1_CTRL2_G,
                                (uint8_t *)&ctrl2_g, 1);
  }
...
int32_t asm330lhhg1_block_data_update_set(const stmdev_ctx_t *ctx,
                                          uint8_t val)
{
  asm330lhhg1_ctrl3_c_t ctrl3_c = {0};
  int32_t ret = {0};
...
{
  asm330lhhg1_ctrl6_c_t ctrl6_c = {0};
  int32_t ret = {0};
...
int32_t asm330lhhg1_xl_flag_data_ready_get(const stmdev_ctx_t *ctx,
                                           uint8_t *val)
{
  asm330lhhg1_status_reg_t status_reg = {0};
  int32_t ret = {0};
                                        ...
                                        int8_t *val)
{
  ...
  ret = asm330lhhg1_write_reg(ctx, ASM330LHHG1_X_OFS_USR, (uint8_t *)val, 1);
                                        ...
                                        int8_t *val)
{
  ...
  ret = asm330lhhg1_read_reg(ctx, ASM330LHHG1_X_OFS_USR, (uint8_t *)val, 1);
                                        ...
                                        int8_t *val)
{
  ...
  ret = asm330lhhg1_write_reg(ctx, ASM330LHHG1_Y_OFS_USR, (uint8_t *)val, 1);
                                        ...
                                        int8_t *val)
{
  ...
  ret = asm330lhhg1_read_reg(ctx, ASM330LHHG1_Y_OFS_USR, (uint8_t *)val, 1);
                                        ...
                                        int8_t *val)
{
  ...
  ret = asm330lhhg1_write_reg(ctx, ASM330LHHG1_Z_OFS_USR, (uint8_t *)val, 1);
                                        ...
                                        int8_t *val)
{
  ...
  ret = asm330lhhg1_read_reg(ctx, ASM330LHHG1_Z_OFS_USR, (uint8_t *)val, 1);
...
{
  asm330lhhg1_ctrl7_g_t ctrl7_g = {0};
  int32_t ret = {0};
  ...
  if (ret == 0)
  {
    ctrl7_g.usr_off_on_out = (uint8_t)(val & 0x01);
...
{
  asm330lhhg1_ctrl10_c_t ctrl10_c = {0};
  int32_t ret = {0};
...
{
  asm330lhhg1_ctrl5_c_t ctrl5_c = {0};
  int32_t ret = {0};
  ...
  if (ret == 0)
  {
    ctrl5_c.rounding = (uint8_t)(val & 0x03);
                                        ...
                                        int16_t *val)
{
  ...
  *val = (int16_t)(((uint16_t)buff[1] << 8) + buff[0]);
                                         ...
                                         int16_t *val)
{
  ...
  val[0] = (int16_t)(((uint16_t)buff[1] << 8) + buff[0]);
  val[1] = (int16_t)(((uint16_t)buff[3] << 8) + buff[2]);
  val[2] = (int16_t)(((uint16_t)buff[5] << 8) + buff[4]);
...
int32_t asm330lhhg1_fifo_out_raw_get(const stmdev_ctx_t *ctx, uint8_t *val)
{
  ...
  ret = asm330lhhg1_read_reg(ctx, ASM330LHHG1_FIFO_DATA_OUT_X_L, val, 6);
...
{
  asm330lhhg1_ctrl9_xl_t ctrl9_xl = {0};
  int32_t ret = {0};
...
{
  asm330lhhg1_internal_freq_fine_t internal_freq_fine = {0};
  int32_t ret = {0};
...
{
  asm330lhhg1_counter_bdr_reg1_t counter_bdr_reg1 = {0};
  int32_t ret = {0};
...
int32_t asm330lhhg1_device_id_get(const stmdev_ctx_t *ctx, uint8_t *val)
{
  ...
  ret = asm330lhhg1_read_reg(ctx, ASM330LHHG1_WHO_AM_I, val, 1);
...
{
  asm330lhhg1_ctrl4_c_t ctrl4_c = {0};
  int32_t ret = {0};
  ...
  if (ret == 0)
  {
    ctrl4_c.lpf1_sel_g = (uint8_t)(val & 0x01);
...
int32_t asm330lhhg1_drdy_mask_set(const stmdev_ctx_t *ctx, uint8_t val)
{
  ...
  if (ret == 0)
  {
    ctrl4_c.drdy_mask = (uint8_t)(val & 0x01);
    ret = asm330lhhg1_write_reg(ctx, ASM330LHHG1_CTRL4_C,
                                (uint8_t *)&ctrl4_c, 1);
  }
                                         ...
                                         asm330lhhg1_ftype_t val)
{
  ...
  if (ret == 0)
  {
    ctrl6_c.ftype = (uint8_t)(val & 0x07);
    ret = asm330lhhg1_write_reg(ctx, ASM330LHHG1_CTRL6_C,
                                (uint8_t *)&ctrl6_c, 1);
  }
...
{
  asm330lhhg1_ctrl8_xl_t ctrl8_xl = {0};
  int32_t ret = {0};
  ...
  if (ret == 0)
  {
    ctrl8_xl.low_pass_on_6d = (uint8_t)(val & 0x01);
                                          ...
                                          asm330lhhg1_hp_slope_xl_en_t val)
{
  ...
  ctrl8_xl.hp_slope_xl_en = (uint8_t)(is_high_pass & 0x01);
  ...
  if (is_high_pass == 0)
  {
    ...
    ctrl1_xl.lpf2_xl_en = (uint8_t)((val >> 7) & 0x01);
                                          ...
                                          asm330lhhg1_hp_slope_xl_en_t *val)
{
  ...
  else
  {
    ...
    {
      case 0x00:
        *val = is_low_pass == 1u ? ASM330LHHG1_LP_ODR_DIV_4 : ASM330LHHG1_SLOPE_ODR_DIV_4;
        break;

      case 0x01:
        *val = is_low_pass == 1u ? ASM330LHHG1_LP_ODR_DIV_10 : ASM330LHHG1_HP_ODR_DIV_10;
        break;

      case 0x02:
        *val = is_low_pass == 1u ? ASM330LHHG1_LP_ODR_DIV_20 : ASM330LHHG1_HP_ODR_DIV_20;
        break;

      case 0x03:
        *val = is_low_pass == 1u ? ASM330LHHG1_LP_ODR_DIV_45 : ASM330LHHG1_HP_ODR_DIV_45;
        break;

      case 0x04:
        *val = is_low_pass == 1u ? ASM330LHHG1_LP_ODR_DIV_100 : ASM330LHHG1_HP_ODR_DIV_100;
        break;

      case 0x05:
        *val = is_low_pass == 1u ? ASM330LHHG1_LP_ODR_DIV_200 : ASM330LHHG1_HP_ODR_DIV_200;
        break;

      case 0x06:
        *val = is_low_pass == 1u ? ASM330LHHG1_LP_ODR_DIV_400 : ASM330LHHG1_HP_ODR_DIV_400;
        break;
                                         ...
                                         uint8_t val)
{
  ...
  if (ret == 0)
  {
    ctrl8_xl.fastsettl_mode_xl = (uint8_t)(val & 0x01);
    ret = asm330lhhg1_write_reg(ctx, ASM330LHHG1_CTRL8_XL,
                                (uint8_t *)&ctrl8_xl, 1);
  }
...
{
  asm330lhhg1_int_cfg0_t int_cfg0 = {0};
  int32_t ret = {0};

  ret = asm330lhhg1_read_reg(ctx, ASM330LHHG1_INT_CFG0, (uint8_t *)&int_cfg0, 1);
  if (ret == 0)
  {
    int_cfg0.slope_fds = (uint8_t)(val & 0x01);
                                            ...
                                            asm330lhhg1_hpm_g_t val)
{
  ...
  if (ret == 0)
  {
    ctrl7_g.hp_en_g = (uint8_t)((val >> 7) & 0x01);
...
{
  asm330lhhg1_pin_ctrl_t pin_ctrl = {0};
  int32_t ret = {0};
  ...
  if (ret == 0)
  {
    pin_ctrl.sdo_pu_en = (uint8_t)(val & 0x01);
                                      ...
                                      asm330lhhg1_i2c_disable_t val)
{
  ...
  if (ret == 0)
  {
    ctrl4_c.i2c_disable = (uint8_t)(val & 0x01);
    ret = asm330lhhg1_write_reg(ctx, ASM330LHHG1_CTRL4_C,
                                (uint8_t *)&ctrl4_c, 1);
  }
...
{
  asm330lhhg1_int_cfg1_t int_cfg1 = {0};
  int32_t ret = {0};
...
{
  asm330lhhg1_pin_int1_route_t pin_int1_route = {0};
  asm330lhhg1_int_cfg1_t int_cfg1 = {0};
  int32_t ret = {0};
                                 ...
                                 asm330lhhg1_pp_od_t val)
{
  ...
  if (ret == 0)
  {
    ctrl3_c.pp_od = (uint8_t)(val & 0x01);
    ret = asm330lhhg1_write_reg(ctx, ASM330LHHG1_CTRL3_C,
                                (uint8_t *)&ctrl3_c, 1);
  }
                                     ...
                                     asm330lhhg1_h_lactive_t val)
{
  ...
  if (ret == 0)
  {
    ctrl3_c.h_lactive = (uint8_t)(val & 0x01);
    ret = asm330lhhg1_write_reg(ctx, ASM330LHHG1_CTRL3_C,
                                (uint8_t *)&ctrl3_c, 1);
  }
...
int32_t asm330lhhg1_all_on_int1_set(const stmdev_ctx_t *ctx, uint8_t val)
{
  ...
  if (ret == 0)
  {
    ctrl4_c.int2_on_int1 = (uint8_t)(val & 0x01);
    ret = asm330lhhg1_write_reg(ctx, ASM330LHHG1_CTRL4_C,
                                (uint8_t *)&ctrl4_c, 1);
  }
...
{
  asm330lhhg1_wake_up_dur_t wake_up_dur = {0};
  int32_t ret = {0};
  ...
  if (ret == 0)
  {
    wake_up_dur.wake_ths_w = (uint8_t)(val & 0x01);
...
{
  asm330lhhg1_wake_up_ths_t wake_up_ths = {0};
  int32_t ret = {0};
  ...
  if (ret == 0)
  {
    wake_up_ths.wk_ths = (uint8_t)(val & 0x3F);
                                              ...
                                              uint8_t val)
{
  ...
  if (ret == 0)
  {
    wake_up_ths.usr_off_on_wu = (uint8_t)(val & 0x01);
    ret = asm330lhhg1_write_reg(ctx, ASM330LHHG1_WAKE_UP_THS,
                                (uint8_t *)&wake_up_ths, 1);
  }
...
int32_t asm330lhhg1_wkup_dur_set(const stmdev_ctx_t *ctx, uint8_t val)
{
  ...
  if (ret == 0)
  {
    wake_up_dur.wake_dur = (uint8_t)(val & 0x03);
    ret = asm330lhhg1_write_reg(ctx, ASM330LHHG1_WAKE_UP_DUR,
                                (uint8_t *)&wake_up_dur, 1);
  }
...
int32_t asm330lhhg1_gy_sleep_mode_set(const stmdev_ctx_t *ctx, uint8_t val)
{
  ...
  if (ret == 0)
  {
    ctrl4_c.sleep_g = (uint8_t)(val & 0x01);
    ret = asm330lhhg1_write_reg(ctx, ASM330LHHG1_CTRL4_C,
                                (uint8_t *)&ctrl4_c, 1);
  }
                                             ...
                                             asm330lhhg1_sleep_status_on_int_t val)
{
  ...
  if (ret == 0)
  {
    int_cfg0. sleep_status_on_int = (uint8_t)(val & 0x01);
    ret = asm330lhhg1_write_reg(ctx, ASM330LHHG1_INT_CFG0,
                                (uint8_t *)&int_cfg0, 1);
  }
                                 ...
                                 asm330lhhg1_inact_en_t val)
{
  ...
  if (ret == 0)
  {
    int_cfg1.inact_en = (uint8_t)(val & 0x03);
    ret = asm330lhhg1_write_reg(ctx, ASM330LHHG1_INT_CFG1, (uint8_t *)&int_cfg1, 1);
  }
...
int32_t asm330lhhg1_act_sleep_dur_set(const stmdev_ctx_t *ctx, uint8_t val)
{
  ...
  if (ret == 0)
  {
    wake_up_dur.sleep_dur = (uint8_t)(val & 0x0F);
    ret = asm330lhhg1_write_reg(ctx, ASM330LHHG1_WAKE_UP_DUR,
                                (uint8_t *)&wake_up_dur, 1);
  }
                                     ...
                                     asm330lhhg1_sixd_ths_t val)
{
  ...
  if (ret == 0)
  {
    ths_6d.sixd_ths = (uint8_t)(val & 0x03);
...
int32_t asm330lhhg1_4d_mode_set(const stmdev_ctx_t *ctx, uint8_t val)
{
  ...
  if (ret == 0)
  {
    ths_6d.d4d_en = (uint8_t)(val & 0x01);
    ret = asm330lhhg1_write_reg(ctx, ASM330LHHG1_THS_6D,
                                (uint8_t *)&ths_6d, 1);
  }
...
{
  asm330lhhg1_free_fall_t free_fall = {0};
  int32_t ret = {0};
  ...
  if (ret == 0)
  {
    free_fall.ff_ths = (uint8_t)(val & 0x07);
...
{
  asm330lhhg1_fifo_ctrl1_t fifo_ctrl1 = {0};
  asm330lhhg1_fifo_ctrl2_t fifo_ctrl2 = {0};
  int32_t ret = {0};
                                       ...
                                       uint16_t *val)
{
  ...
  *val = (uint16_t)(((uint16_t)fifo_ctrl2.wtm << 8) + fifo_ctrl1.wtm);
                                                  ...
                                                  uint8_t val)
{
  ...
  if (ret == 0)
  {
    fifo_ctrl2.odrchg_en = (uint8_t)(val & 0x01);
                                         ...
                                         uint8_t val)
{
  ...
  if (ret == 0)
  {
    fifo_ctrl2.stop_on_wtm = (uint8_t)(val & 0x01);
    ret = asm330lhhg1_write_reg(ctx, ASM330LHHG1_FIFO_CTRL2,
                                (uint8_t *)&fifo_ctrl2, 1);
  }
...
{
  asm330lhhg1_fifo_ctrl3_t fifo_ctrl3 = {0};
  int32_t ret = {0};
...
{
  asm330lhhg1_fifo_ctrl4_t fifo_ctrl4 = {0};
  int32_t ret = {0};
                                                  ...
                                                  asm330lhhg1_dec_ts_batch_t val)
{
  ...
  if (ret == 0)
  {
    fifo_ctrl4.dec_ts_batch = (uint8_t)(val & 0x03);
    ret = asm330lhhg1_write_reg(ctx, ASM330LHHG1_FIFO_CTRL4,
                                (uint8_t *)&fifo_ctrl4, 1);
  }
                                             ...
                                             asm330lhhg1_trig_counter_bdr_t val)
{
  ...
  if (ret == 0)
  {
    counter_bdr_reg1.trig_counter_bdr = (uint8_t)(val & 0x01);
    ret = asm330lhhg1_write_reg(ctx, ASM330LHHG1_COUNTER_BDR_REG1,
                                (uint8_t *)&counter_bdr_reg1, 1);
  }
                                          ...
                                          uint8_t val)
{
  ...
  if (ret == 0)
  {
    counter_bdr_reg1.rst_counter_bdr = (uint8_t)(val & 0x01);
    ret = asm330lhhg1_write_reg(ctx, ASM330LHHG1_COUNTER_BDR_REG1,
                                (uint8_t *)&counter_bdr_reg1, 1);
  }
...
int32_t asm330lhhg1_batch_counter_threshold_set(const stmdev_ctx_t *ctx,
                                                uint16_t val)
{
  asm330lhhg1_counter_bdr_reg2_t counter_bdr_reg1 = {0};
  asm330lhhg1_counter_bdr_reg2_t counter_bdr_reg2 = {0};
  int32_t ret = {0};
                                                ...
                                                uint16_t *val)
{
  ...
  *val = (uint16_t)(((uint16_t)counter_bdr_reg1.cnt_bdr_th << 8) +  counter_bdr_reg2.cnt_bdr_th);
...
{
  uint8_t reg[2] = {0};
  const asm330lhhg1_fifo_status1_t *fifo_status1 = (asm330lhhg1_fifo_status1_t *)&reg[0];
  const asm330lhhg1_fifo_status2_t *fifo_status2 = (asm330lhhg1_fifo_status2_t *)&reg[1];
  int32_t ret = {0};
  ...
  if (ret == 0)
  {
    *val = (uint16_t)(((uint16_t)fifo_status2->diff_fifo << 8) + fifo_status1->diff_fifo);
  }
...
{
  asm330lhhg1_fifo_data_out_tag_t fifo_data_out_tag = {0};
  int32_t ret = {0};
                                 ...
                                 asm330lhhg1_den_mode_t val)
{
  ...
  if (ret == 0)
  {
    ctrl6_c.den_mode = (uint8_t)(val & 0x07);
    ret = asm330lhhg1_write_reg(ctx, ASM330LHHG1_CTRL6_C,
                                (uint8_t *)&ctrl6_c, 1);
  }
                                     ...
                                     asm330lhhg1_den_lh_t val)
{
  ...
  if (ret == 0)
  {
    ctrl9_xl.den_lh = (uint8_t)(val & 0x01);
    ret = asm330lhhg1_write_reg(ctx, ASM330LHHG1_CTRL9_XL,
                                (uint8_t *)&ctrl9_xl, 1);
  }
                                   ...
                                   asm330lhhg1_den_xl_g_t val)
{
  ...
  if (ret == 0)
  {
    ctrl9_xl.den_xl_g = (uint8_t)(val & 0x03);
    ret = asm330lhhg1_write_reg(ctx, ASM330LHHG1_CTRL9_XL,
                                (uint8_t *)&ctrl9_xl, 1);
  }
...
int32_t asm330lhhg1_den_mark_axis_x_set(const stmdev_ctx_t *ctx, uint8_t val)
{
  ...
  if (ret == 0)
  {
    ctrl9_xl.den_x = (uint8_t)(val & 0x01);
    ret = asm330lhhg1_write_reg(ctx, ASM330LHHG1_CTRL9_XL,
                                (uint8_t *)&ctrl9_xl, 1);
  }
...
int32_t asm330lhhg1_den_mark_axis_y_set(const stmdev_ctx_t *ctx, uint8_t val)
{
  ...
  if (ret == 0)
  {
    ctrl9_xl.den_y = (uint8_t)(val & 0x01);
    ret = asm330lhhg1_write_reg(ctx, ASM330LHHG1_CTRL9_XL,
                                (uint8_t *)&ctrl9_xl, 1);
  }
...
int32_t asm330lhhg1_den_mark_axis_z_set(const stmdev_ctx_t *ctx, uint8_t val)
{
  ...
  if (ret == 0)
  {
    ctrl9_xl.den_z = (uint8_t)(val & 0x01);
    ret = asm330lhhg1_write_reg(ctx, ASM330LHHG1_CTRL9_XL,
                                (uint8_t *)&ctrl9_xl, 1);
  }
